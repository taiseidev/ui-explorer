  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: 0,
        unselectedItemColor: const Color(0xff5d5e5d),
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.add_to_drive_sharp), label: '雑貨'),
          BottomNavigationBarItem(icon: Icon(Icons.search), label: '検索'),
          BottomNavigationBarItem(
              icon: Icon(Icons.shopping_cart_rounded), label: 'カート'),
          BottomNavigationBarItem(
              icon: Icon(Icons.account_box_rounded), label: 'アカウント'),
        ],
      ),
    );
  }
